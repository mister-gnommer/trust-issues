...
Full data: [20260621-data.md](20260621-data.md)
...
##### Track test
- χ² = 7.00, df = 3, p = 0.0719, V = 0.5401
- **Result**: not flagged (p >= 0.01)

> ⚠️ **Track test warning**: minimum expected count = 2.00 (< 5), chi-squared result may be unreliable.
...
Full tables: [20260621-data.md](20260621-data.md)
...
##### Track test
- χ² = 10.00, df = 3, p = 0.0186, V = 0.5270
- **Result**: not flagged (p >= 0.01)
